...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonSave = (Button) inflatedView.findViewById(R.id.buttonSave);
        buttonLoad = (Button) inflatedView.findViewById(R.id.buttonLoad);
        editTextName= (EditText) inflatedView.findViewById(R.id.editTextName);
